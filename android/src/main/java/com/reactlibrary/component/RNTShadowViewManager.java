...
public class RNTShadowViewManager extends ViewGroupManager<ShadowView> {
    ...
    public void setBorderRadius(final ShadowView shadowView, double borderRadius) {
        if (shadowView != null) {
    ...
    public void setBorderWidth(final ShadowView shadowView, double borderWidth) {
        if (shadowView != null) {
    ...
    public void setShadowOffsetX(final ShadowView shadowView, double shadowOffsetX) {
        if (shadowView != null) {
    ...
    public void setShadowOffsetY(final ShadowView shadowView, double shadowOffsetY) {
        if (shadowView != null) {
    ...
    public void setShadowOpacity(final ShadowView shadowView, double shadowOpacity) {
        if (shadowView != null) {
    ...
    @NonNull
    @Override
    public ShadowView createViewInstance(@NonNull ThemedReactContext context) {
